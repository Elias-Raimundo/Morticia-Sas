    ...
    <div className="min-h-screen bg-gradient-to-b from-amber-50 via-white to-white p-6 space-y-6">
      ...
      <div className="rounded-2xl border border-amber-200 bg-white shadow-sm overflow-hidden">
        ...
        <div className= "flex items-center gap-4 p-6">
          <img src = "/logo2.jpeg" alt="Morticia" className="w-18 h-18 rounded-lg object-cover border border-gray-200" />
        <div>
      ...
      <div className="rounded-2xl border border-gray-200 bg-white shadow-sm overflow-hidden">
        ...
        <div className="p-5">
          <div className="grid grid-cols-1 md:grid-cols-5 gap-3">
            ...
            <button
              className="rounded-lg px-4 py-2 font-medium bg-amber-500 hover:bg-amber-600 text-gray-950 transition"
              onClick={create}
            >
              Crear
            </button>
      ...
      <div className="rounded-2xl border border-gray-200 bg-white shadow-sm overflow-hidden">
        <div className="px-5 py-4 border-b bg-gray-50">
          ...
          <p className="text-sm text-gray-600">
            Edita nombre, unidad, precio, stock y activacion
          </p>
        </div>
          ...
          >
            ...
            <div className = "col-span-2">
              {isEditing? (
                ...
                <span className="text-gray-900">${Number(p.price).toLocaleString()}</span>  
              )}
            </div>
